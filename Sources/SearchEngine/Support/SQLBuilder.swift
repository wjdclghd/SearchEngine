...
///
/// 복잡한 쿼리 작성은 검색 실행기와 제안 생성기에서 다루게 되므로,
/// 공통적으로 자주 쓰는 조립 기능만 제공합니다.
...
enum SQLBuilder {
    ...
    struct SortClause: Equatable, Sendable {
        ...
        /// SortClause를 생성합니다.
        ///
        /// - Parameter column: 정렬에 사용할 컬럼 이름입니다.
        /// - Parameter direction: 정렬 방향입니다.
        init(
            column: String,
    ...
    ///
    /// - Parameter count: 생성할 placeholder 개수입니다.
    ///
    /// - Returns: 쉼표로 연결된 placeholder 문자열입니다.
    ...
    ///
    /// - Parameter columns: assignment에 사용할 컬럼 목록입니다.
    ///
    /// - Returns: "column = ?" 형식의 assignment 문자열입니다.
    ...
    ///
    /// - Parameter clauses: 정렬 기준 목록입니다.
    ///
    /// - Returns: ORDER BY 절 문자열 또는 빈 문자열입니다.
