...
public enum SearchEngineError: Error, Equatable, LocalizedError, Sendable {
    ...
    */
    ...
    /*
     ...
     - Parameter String: 잘못된 문서 필드와 실패 원인을 설명하는 메시지입니다.
    */
    ...
    /*
     ...
     - Parameter String: 잘못된 질의 조건과 실패 원인을 설명하는 메시지입니다.
    */
    ...
    /*
     ...
     - Parameter String: 경로 생성 실패 원인을 설명하는 메시지입니다.
    */
    ...
    /*
     ...
     - Parameter String: sqlite3_open_v2 또는 초기 pragma 적용 실패 원인을 설명하는 메시지입니다.
    */
    ...
    */
    ...
    /*
     ...
     - Parameter String: 트랜잭션 시작, commit, rollback 또는 내부 작업 실패 원인을 설명하는 메시지입니다.
    */
