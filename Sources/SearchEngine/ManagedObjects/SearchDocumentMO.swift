...
/*
 SearchDocument를 SQLite 저장 계층에서 사용하는 내부 ManagedObject 표현입니다.

 이 타입은 Core Data NSManagedObject가 아니라 SQLite 테이블과 FTS projection에 맞춘 값 타입입니다.
 StoreImplementations 계층은 이 타입을 사용해 저장 규칙을 일관되게 유지하고,
 Mappers 계층은 이 타입과 SearchDocument 사이를 변환합니다.
 */
struct SearchDocumentMO: Equatable, Sendable {
    /*
